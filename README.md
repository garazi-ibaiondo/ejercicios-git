# [Kata Git](https://es.wikipedia.org/wiki/Kata_(programaci%C3%B3n))

## Para iniciarse

- Clona este repositorio
- Movete al directorio de los ejercicios que quieres resolver
- Ejecuta el script `setup.sh`
- Ejecuta `git log --oneline -- directorio` para conocer los ejercicios que debes resolver

## Proposito del repositorio

Este repositorio es una colección de ejercicios de Git.
El concepto ha sido robado sin pudor de [Eficode-academy](https://github.com/eficode-academy/git-katas).

Los ejercicios están diseñados para usarse cuando impartimos cursos de Git. Deberías poder usarlos como ejercicios independientes que te permitirán mantener tus habilidades con Git en forma.

## Cheatsheet

Una colección de comandos útiles para utilizar a lo largo de los ejercicios:
